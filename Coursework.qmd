...
plt.figtext(0.5, -0.1, "Figure 6: ROC Curve for Logistic Regression Model", ha="center", fontsize=11)
plt.legend()
plt.show()
```
...
### **3.2 Random Forest**
The second model that was developed was an RF  
...
imp_Feature_1 = importance_df_rf[Feature_1].round(3)
imp_Feature_2 = importance_df_rf[Feature_2].round(3)
imp_Feature_3 = importance_df_rf[Feature_3].round(3)
```
