...
plt.xlabel('Stage')
plt.ylabel('Count')
plt.figtext(0.5, -0.07, "Figure ?: Distribution of Default Before and After Downsampling", ha="center", fontsize=11)
...
plt.figtext(0.5, -0.14, "Figure ?: Correlation Plot of All Variables ", ha="center", fontsize=16)
plt.show()
