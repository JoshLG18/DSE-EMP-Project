...
param_grid = {
    ...
    'reg_alpha': [0, 0.1, 0.5],  # L1 regularization (feature selection)
    'reg_lambda': [0.5, 1, 2]  # L2 regularization (weight shrinkage)
}
...
plt.xlabel("Predicted Class")
plt.ylabel("Actual Class")
plt.suptitle("Figure 13: Confusion Matrix for XGBoost Model", y = -0.1, fontsize=9)
plt.show()
...
plt.xlabel('Importance')
plt.ylabel('Feature')
plt.suptitle("Figure 14: Feature Importances from XGBoost Model", y = -0.1, fontsize=10, x = 0.5)
plt.show()
