...
with open("Tables/missing_values_table.tex", "w") as f:
...
# Save to a LaTeX file
with open("Tables/variable_info_table.tex", "w") as f:
...
# Save to a LaTeX file
with open("Tables/vif_table.tex", "w") as f:
    f.write(vif_latex)
```
...
# Save to a LaTeX file
with open("Tables/performance_table.tex", "w") as f:
