...
loan_data.boxplot()
plt.figtext(0.5, -0.3, "Figure 2: Box Plots of All Variables Before Normalisation", ha="center", fontsize=9)
...
plt.figure(figsize=(8,2.5))
loan_data.boxplot()
plt.figtext(0.5, -0.3, "Figure 3: Box Plots of All Variables After Normalisation", ha="center", fontsize=9)
plt.xticks(rotation=45)
plt.show()
```
